...
class PermissionLabelProvider @Inject constructor(@ApplicationContext private val context: Context, private val packageManager: PackageManager) {
    ...
    private fun buildKnownLabels(): Map<String, String> = mapOf(
        ...
        "android.permission.READ_CALENDAR" to context.getString(R.string.permission_label_calendar_read),
        "android.permission.WRITE_CALENDAR" to context.getString(R.string.permission_label_calendar_write),
        ...
        "android.permission.FOREGROUND_SERVICE_CAMERA" to context.getString(R.string.permission_label_foreground_service_camera),
        "android.permission.FOREGROUND_SERVICE_MICROPHONE" to context.getString(R.string.permission_label_foreground_service_microphone),
        "android.permission.FOREGROUND_SERVICE_DATA_SYNC" to context.getString(R.string.permission_label_foreground_service_data_sync),
        "android.permission.FOREGROUND_SERVICE_MEDIA_PLAYBACK" to context.getString(R.string.permission_label_foreground_service_media_playback),
        "android.permission.FOREGROUND_SERVICE_MEDIA_PROJECTION" to context.getString(R.string.permission_label_foreground_service_media_projection),
        "android.permission.FOREGROUND_SERVICE_PHONE_CALL" to context.getString(R.string.permission_label_foreground_service_phone_call),
        "android.permission.FOREGROUND_SERVICE_CONNECTED_DEVICE" to context.getString(R.string.permission_label_foreground_service_connected_device),
        "android.permission.ACCESS_ADSERVICES_AD_ID" to context.getString(R.string.permission_label_ad_id),
        "com.google.android.gms.permission.AD_ID" to context.getString(R.string.permission_label_ad_id),
        "android.permission.ACCESS_ADSERVICES_ATTRIBUTION" to context.getString(R.string.permission_label_ad_attribution),
        "android.permission.ACCESS_ADSERVICES_CUSTOM_AUDIENCE" to context.getString(R.string.permission_label_ad_custom_audience),
        "android.permission.ACCESS_ADSERVICES_TOPICS" to context.getString(R.string.permission_label_ad_topics),
        "android.permission.USE_FULL_SCREEN_INTENT" to context.getString(R.string.permission_label_full_screen_intent),
        "com.google.android.c2dm.permission.RECEIVE" to context.getString(R.string.permission_label_push_messages),
        "android.permission.GET_TASKS" to context.getString(R.string.permission_label_running_apps),
        "android.permission.REORDER_TASKS" to context.getString(R.string.permission_label_reorder_running_apps),
        "android.permission.BLUETOOTH_ADMIN" to context.getString(R.string.permission_label_bluetooth_settings),
        "android.permission.MODIFY_AUDIO_SETTINGS" to context.getString(R.string.permission_label_audio_settings),
        "android.permission.CHANGE_NETWORK_STATE" to context.getString(R.string.permission_label_network_change),
        "android.permission.BROADCAST_STICKY" to context.getString(R.string.permission_label_sticky_broadcast),
        "android.permission.MANAGE_OWN_CALLS" to context.getString(R.string.permission_label_manage_own_calls),
        "android.permission.DETECT_SCREEN_CAPTURE" to context.getString(R.string.permission_label_detect_screen_capture),
        "android.permission.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS" to context.getString(R.string.permission_label_ignore_battery_optimizations),
        "android.permission.READ_SYNC_SETTINGS" to context.getString(R.string.permission_label_sync_settings_read),
        "android.permission.WRITE_SYNC_SETTINGS" to context.getString(R.string.permission_label_sync_settings_write),
        "com.google.android.providers.gsf.permission.READ_GSERVICES" to context.getString(R.string.permission_label_google_services_config),
