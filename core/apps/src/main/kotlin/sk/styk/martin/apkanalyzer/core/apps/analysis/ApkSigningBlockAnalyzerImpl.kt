...
internal class ApkSigningBlockAnalyzerImpl @Inject constructor() : ApkSigningBlockAnalyzer {
    ...
    private fun readSigningBlockVersions(apkPath: String): Set<SigningSchemeVersion>? = RandomAccessFile(apkPath, "r").use(::parseSigningBlock)
