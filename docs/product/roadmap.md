...
FR-45, FR-46, FR-27, FR-31 (blocked on `OQ-01`), FR-37, FR-38, FR-44 (Backlog), plus `EN`.
...
|----|-----------------|-----------------------------------------------------------------------------------------|----------------|------------|
| R0 | Free Rework     | Remaining: FR-45, FR-46, FR-17, FR-18, CE-06, FR-27, FR-31, FR-37, FR-38, FR-44, plus `EN` — rest shipped, see [shipped.md](shipped.md) | ~7–8 weeks     | Week 8     |
